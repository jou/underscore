...
(function() {
  ...
  _.map = function(obj, iterator, context) {
    if (nativeMap && obj.map === nativeMap && !compatibility.brokenMap()) return obj.map(iterator, context);
    var results = [];
  ...
  _.reduce = function(obj, iterator, memo, context) {
    if (nativeReduce && obj.reduce === nativeReduce && !compatibility.brokenReduce()) {
